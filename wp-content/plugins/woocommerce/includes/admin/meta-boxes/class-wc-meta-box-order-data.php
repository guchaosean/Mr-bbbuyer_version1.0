	...
	public static function output( $post ) {
		...
		<div class="panel-wrap woocommerce">
			...
			<div id="order_data" class="panel">
				...
				<?php  $stattts= $order->get_status(); 
				   // if ($stattts=="on-hold"){
						echo  '<a href="../wp-content/plugins/woocommerce/includes/admin/meta-boxes/wc_view_pay_detail.php?orderid='. $order->get_order_number() .'" target="_blank">点击查看支付详情</a>';
