...
class WC_Gateway_Cheque extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->description  = "您可以在稍后的24小时之内付款，超过24小时订单将自动关闭。付款请点击页面上方“我的账户信息”进行付款。";
		
		//$this->instructions = $this->get_option( 'instructions', $this->description );
	    $this->instructions ="请在稍后的24小时之内付款，超过24小时订单将自动关闭。付款请点击页面上方“我的账户信息”进行付款。如有任何问题，请微信联系掌柜。";
    ...
    public function init_form_fields() {
    	...
    	$this->form_fields = array(
			...
			'description' => array(
				...
				'default'     => __( '您可以在稍后的24小时之内付款，超过24小时订单将自动关闭。付款请点击页面上方“我的账户信息”进行付款。', 'woocommerce' ),
				'desc_tip'    => true,
			),
			'instructions' => array(
				...
				//'default'     => '',
				'default'     => __( '请在稍后的24小时之内付款，超过24小时订单将自动关闭。付款请点击页面上方“我的账户信息”进行付款。如有任何问题，请微信联系掌柜。', 'woocommerce' ),
				'desc_tip'    => true,
			),
		);
    }
	...
	public function process_payment( $order_id ) {
		...
		//$order->update_status( 'on-hold', __( 'Awaiting cheque payment', 'woocommerce' ) );
		  $order->update_status( 'pending', __( 'Pending payment From User', 'woocommerce' ) );
		// Reduce stock levels
