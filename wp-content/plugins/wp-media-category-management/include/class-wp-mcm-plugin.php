...
//		return $form_fields;
	...
	function mcm_enqueue_media_action() {
		...
		if ( wp_script_is( 'media-editor' ) && (('upload.php' == $pagenow ) || ('post.php' == $pagenow ) || ('post-new.php' == $pagenow ) )) {
			...
			$no_categories  = ( $media_taxonomy == WP_MCM_TAGS_TAXONOMY ) ? __( 'No tags', 'wp-media-category-management' ) : __( 'No categories', 'wp-media-category-management' );
			$all_categories = ( $media_taxonomy == WP_MCM_TAGS_TAXONOMY ) ? __( 'View all tags', 'wp-media-category-management' ) : __( 'View all categories', 'wp-media-category-management' );
