	...
	switch ($media_taxonomy) {
		case WP_MCM_TAGS_TAXONOMY:
			$dropdown_options_extra = array(
				'name'               => $media_taxonomy,
				'show_option_all'    => __( 'View all tags', 'wp-media-category-management' ),
				'show_option_none'   => __( 'No tags', 'wp-media-category-management' ),
				'show_count'         => false,
				'value'              => 'slug'
			);
			break;
		case WP_MCM_POST_TAXONOMY:
			$dropdown_options_extra = array(
				'show_option_all'    => __( 'View all categories', 'wp-media-category-management' ),
				'show_option_none'   => __( 'No categories', 'wp-media-category-management' ),
				'show_count'         => false,
				'value'              => 'id'
			);
			break;
