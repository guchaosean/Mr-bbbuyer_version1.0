...
class WP_MCM_Widget_Categories extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 'classname' => 'mcm_widget_categories', 'description' => __( "A list or dropdown of MCM categories.", 'wp-media-category-management' ) );
		parent::__construct('mcm_categories', __('MCM Categories', 'wp-media-category-management'), $widget_ops);
	}
